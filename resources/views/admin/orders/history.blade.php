...
<div class="col-12">
    ...
    <div class="card-header">
        <div class="row">
            <div class="col-md-12">
                <a href="{{route('new-orders')}}" class="btn btn-warning float-right">New Order</a>
            </div>
        </div>
    </div><!-- card-header end  -->
        ...
        <table id="table_id" class="display">
            ...
            <tbody>                
                ...
                <tr>
                    ...
                    <td style="padding: 8px;">{{$order->status == '0' ?'pending' : 'completed'}}</td>

                    <td style="padding: 8px;"><small class="badge badge-primary">
