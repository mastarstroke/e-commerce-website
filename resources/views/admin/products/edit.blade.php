        ...
        @csrf
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                  <label for="">Category</label>
                    <select class="form-select form-control" name="cate_id">
                        ...
                        <option value="{{$item->id}}">{{$product->categories->name}}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="checkbox" {{ $product->bestsell == 'YES' ? 'checked' : ''}} name="bestsell">
                </div>

                <div class="col-md-6 mb-3">
                    @if ($product->image)
                    <img width="250" src="/productimage/{{$product->image}}" alt="">
                    @endif
